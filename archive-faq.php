...
<main class="main-content">
    ...
    <section class="features-section" id="features" style="background-color: white;">
        <div class="container">
            <div class="section-title">
                <h2 class="slash-title">
                    <?php echo nl2br(get_post_meta($post->ID, 'area_title02', true)); ?>
                </h2>
            </div>
            
            <div class="features-grid">
                <div>
                    <?php echo nl2br(get_post_meta($post->ID, 'area_content02', true)); ?>
                </div>
    ...
    <section class="features-section">
        <div class="container">
            <div class="section-title">
                <h2 class="slash-title">
                    <?php echo nl2br(get_post_meta($post->ID, 'area_title03', true)); ?>
                </h2>
            </div>
            ...
            <div class="features-grid">
                ...
                <div>
                    <?php echo nl2br(get_post_meta($post->ID, 'area_content03', true)); ?>
                </div>
    ...
    <section class="features-section" style="background-color: white;">
        <div class="container">
            <div class="section-title">
                <h2 class="slash-title">
                    <?php echo nl2br(get_post_meta($post->ID, 'area_title04', true)); ?>
                </h2>
            </div>
            
            <div class="features-grid">
                <div>
                    <?php echo nl2br(get_post_meta($post->ID, 'area_content04', true)); ?>
                </div>
            ...
            <div class="services-grid">
                <div style="margin-top:20px; text-align:center;">
                    <iframe src="<?php echo nl2br(get_post_meta($post->ID, 'map_url', true)); ?>" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section>
